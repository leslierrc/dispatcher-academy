        ...
        <div ref={ref} className="max-w-[1440px] mx-auto" style={{ perspective: 1600 }}>
          ...
          >
            {t.pricing.tiers.map((tier, i) => {
              const featured = tier.key === highlightTier;
              return (
                <motion.div
                  key={tier.key}
                ...
                >
                  ...
                  <div className="font-heading font-semibold text-[22px] text-neutral-100">{tier.name}</div>
                  <div className="text-[13px] opacity-55 mt-1.5 mb-6.5 text-neutral-300">{tier.tagline}</div>
                  ...
                  <a
                    href="#"
                    className="flex justify-center items-center w-full rounded-md px-4 py-3.5 text-sm font-heading font-semibold transition-transform hover:scale-[1.02]"
                    style={{
